            ...
            <div class="panel panel-default">
                <div class="panel-body">
                        ...
                        <form method="post" action="cadastro2.php">
                            ...
                            <input  class="form-control" type="text" name="preco" id="preco" size="30" required>
                            <br><br>
                            <input type="submit" class="btn btn-large btn-primary" value="Incluir Produto">
                            <input type="reset" class="btn btn-large btn-danger" value="Limpar">
                        </form>
