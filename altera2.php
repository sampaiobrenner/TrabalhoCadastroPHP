            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <form>
                        ...
                        <input  class="form-control"type="text" name="nome" id="nome" value="<?php echo "$id"; ?>"readonly>
                        <br>
                    ...
                    if ($comando) {
                        ...
                        echo '<div class="alert alert-error">Desculpe, o produto não pode ser alterado!</div>';
                    }
                    ?>
